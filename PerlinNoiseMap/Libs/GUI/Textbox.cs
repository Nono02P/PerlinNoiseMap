    ...
    public class Textbox : Element, IIntegrableMenu
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            if (Visible)
            {
                ...
                spriteBatch.DrawString(Font, Text, Position + PositionBck, colorBck, Angle, Origin, Scale, SpriteEffects.None, 1);
                spriteBatch.DrawString(Font, Text, Position, color, Angle, Origin, Scale, SpriteEffects.None, 0);
            }
        }
        #endregion
